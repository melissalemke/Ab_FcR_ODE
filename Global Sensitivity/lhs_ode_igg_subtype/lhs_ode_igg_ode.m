...
function dy = lhs_ode_igg_ode(t, y, params)
...
fe34 = y(23);
fe44 = y(24);
sum_FcR_complexes = y(25);

% on an off rates for each specific reaction
k1f = 2*f1; %kon for reaction 1
k1r = r1; %koff for reaction 1
k2f = 2*f2; %kon for reaction 2 ...
k2r = r2;
k3f = 2*f3;
k3r = r3;
k4f = 2*f4;
...
dfe34 = react29;
dfe44 = react30;
dsum_FcR_complexes = dfe11+dfe12+dfe13+dfe14+dfe22+dfe23+dfe24+dfe33+dfe34+dfe44;

% [uM/s] product
dy=[de1;de2;de3;de4;de11;de12;de13;de14;de22;de23;de24;de33;de34;de44;...
    dfe11;dfe12;dfe13;dfe14;dfe22;dfe23;dfe24;dfe33;dfe34;dfe44;dsum_FcR_complexes];  
end
